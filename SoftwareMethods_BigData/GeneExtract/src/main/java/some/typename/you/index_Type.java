...
public class index_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("some.typename.you.index");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "some.typename.you.index");
  ...
  public String getNAME(int addr) {
      ...
      jcas.throwFeatMissing("NAME", "some.typename.you.index");
