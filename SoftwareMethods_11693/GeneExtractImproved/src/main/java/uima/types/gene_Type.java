...
public class gene_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.types.gene");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "uima.types.gene");
  ...
  public String getNAME(int addr) {
      ...
      jcas.throwFeatMissing("NAME", "uima.types.gene");
