...
public class numberIndex_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("some.typename.you.numberIndex");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "some.typename.you.numberIndex");
  ...
  public String getNAME(int addr) {
      ...
      jcas.throwFeatMissing("NAME", "some.typename.you.numberIndex");
